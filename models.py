...
def resnet_model2(input_layer, start_neurons):
    ...
    conv3 = Conv2D(start_neurons * 1, (3, 3), activation="relu", padding="same")(conv3)
    conv3 = BatchNormalization()(conv3)
    ...
    conv4 = Conv2D(start_neurons * 1, (3, 3), activation="relu", padding="same")(conv4)
    conv4 = BatchNormalization()(conv4)
    ...
    conv5 = Conv2D(start_neurons * 2, (3, 3), activation="relu", padding="same")(conv5)
    conv5 = BatchNormalization()(conv5)
    ...
    conv7 = Conv2D(start_neurons * 4, (1, 1), activation="relu", padding="same")(add4)
...
def res_u_net(input_layer, start_neurons):
    ...
    add4 = add([conv5, conv6])
    conv7 = Conv2DTranspose(start_neurons * 2, (3, 3), strides=(2, 2), padding="same")(add4)
    conv7 = Conv2D(start_neurons * 4, (1, 1), activation="relu", padding="same")(conv7)
    conv7 = BatchNormalization()(conv7)
    conv7 = Conv2D(start_neurons * 2, (1, 1), activation="relu", padding="same")(conv7)
    conv7 = BatchNormalization()(conv7)
